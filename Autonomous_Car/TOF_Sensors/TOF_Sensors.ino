...
#define LOX3_ADDRESS 0x24
#define LOX4_ADDRESS 0x26
#define LOX5_ADDRESS 0x28
#define LOX6_ADDRESS 0x30
#define LOX7_ADDRESS 0x32
...
void read_dual_sensors() {
  ...
  lox3.rangingTest(&measure3, true); // pass in 'true' to get debug data printout!
